...
//        table.setPreferredSize(new Dimension(1200 - 250, 600));
        ...
        ArrayList<String> maNvItems = new ArrayList<>();
        qlhd.dshd.forEach((t) -> {
            maNvItems.add(t.getMaNhanVien());
        });
//        txtMaNv.addItem(maNvItems);
...
//    class popupForm extends JFrame {
//
//        JTextField txtMaHd = new JTextField();
//        JTextField txtMaNv = new JTextField();
//        JTextField txtMaKh = new JTextField();
...
//            qlhd.readDB();
//            tb.setHeaders(new String[]{"Mã hóa đơn", "Mã nhân viên", "Mã khách hàng", "Ngày lập", "Giờ lập", "Tổng tiền"});
////            qlcthd.readDB();
////        System.out.println(new ConnectDB());
//            tb.clear();
//            qlhd.dshd.forEach((hd) -> {
...
//            MyTable tbSearch = new MyTable();
//            tbSearch.setHeaders(new String[]{"Mã hóa đơn", "Mã nhân viên", "Mã khách hàng", "Ngày lập", "Giờ lập", "Tổng tiền"});
//            tbSearch.clear();
//            qlhd.search(timComboBox.getSelectedItem().toString(), txtSearchbox.getText()).forEach((hd) -> {
//                String[] row = new String[]{hd.getMaHoaDon(), hd.getMaNhanVien(), hd.getMaKhachHang(), hd.getNgayLap().toString(), hd.getGioLap().toString(), String.valueOf(hd.getTongTien())};
//                tbSearch.addRow(row);
