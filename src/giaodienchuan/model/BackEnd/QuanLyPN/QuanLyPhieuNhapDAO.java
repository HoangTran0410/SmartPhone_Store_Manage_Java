...
public class QuanLyPhieuNhapDAO {
    ...
    public Boolean add(PhieuNhap pn) {
        connection = new ConnectionDB();
        Boolean ok = connection.sqlUpdate("INSERT INTO phieunhap(MaPN,MaNCC,MaNV,NgayNhap,GioNhap,TongTien) VALUES ('" + pn.getMaPN() + "','" + pn.getMaNV() + "','" + pn.getMaNCC() + "','" + pn.getNgayNhap() + "','" + pn.getGioNhap() + "','" + pn.getTongTien() + "');");
        connection.closeConnect();
        return ok;
    }
    ...
    public Boolean update(PhieuNhap pn) {
        connection = new ConnectionDB();
        Boolean ok = connection.sqlUpdate("UPDATE phieunhap SET MaNCC='" + pn.getMaNCC() + "', MaNV='" + pn.getMaNV() + "', NgayNhap='" + pn.getNgayNhap() + "', GioLap='" + pn.getGioNhap() + "', TongTien='" + pn.getTongTien() + "' WHERE MaPN='" + pn.getMaPN() + "';");
        connection.closeConnect();
        return ok;
    }
